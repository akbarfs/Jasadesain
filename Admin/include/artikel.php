        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="content-panel">
                <div class="col-md-8"><h4><i class="fa fa-angle-right"></i> List Artikel</h4></div>
                <div class="col">
                ...
                <div class="col"><a href="index.php?include=tambah-artikel">
                ...
                <table class="table table-responsive table-bordered table-striped table-condensed">
                  ...
                  <tbody>
                    ...
                    <td class="text-center"><?php echo $no;?></td>
                      ...
                      'index.php?include=artikel&aksi=hapus&data=<?php echo 
