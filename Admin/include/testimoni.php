        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="content-panel">
                <div class="col-md-8"><h4><i class="fa fa-angle-right"></i> List Testimoni</h4></div>
                <div class="col">
              ...
              <section id="unseen">
                <table class="table table-responsive table-bordered table-striped table-condensed">
                  ...
                  <tbody>
                    ...
                    $sql_k = "SELECT `id`,`nama`,  
                    `testimoni` FROM `testimoni` "; 
                    ...
                    $id = $data_k[0];
                    $nama_tester = $data_k[1];
                    $testimoni = $data_k[2];
                    ?>

                    <tr>
                    <td align="center"><?php echo $no;?></td>
                      <td><?php echo $nama_tester;?></td>
                      <td><?php echo $testimoni;?></td>
                      <td align="center">
                      <a href="index.php?include=detail-testimoni&data=<?php echo $id;?>" 
                      class="btn btn-xs btn-info"><i class="nc-icon nc-alert-circle-i"></i></a>
                      <a href="index.php?include=edit-testimoni&data=<?php echo $id;?>" 
                      ...
                      <?php echo $nama_tester; ?>?'))window.location.href = 
                      'index.php?include=testimoni&aksi=hapus&data=<?php echo 
