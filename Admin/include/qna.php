        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="content-panel">
                <div class="col-md-8"><h4><i class="fa fa-angle-right"></i> List QnA</h4></div>
                <div class="col">
                ...
                <div class="col"><a href="index.php?include=tambah-qna">
              ...
              <section id="unseen">
                <table class="table table-responsive table-bordered table-striped table-condensed">
                  ...
                  <tbody>
                    ...
                    $sql_k = "SELECT `id`,`tanya`,  
                    `jawab` FROM `qna` "; 

                    $sql_k .= " ORDER BY `tanya`";
                    ...
                    <td class="text-center"><?php echo $no;?></td>
                      ...
                      <td align="center">
                      <a href="index.php?include=edit-qna&data=<?php echo $id;?>" 
                      ...
                      <?php echo $tanya; ?>?'))window.location.href = 
                      'index.php?include=qna&aksi=hapus&data=<?php echo 
