...
$sql_k = "SELECT `id_kategori`,`judul` FROM `portfolio` WHERE `id`='$id'";
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="content-panel">
                <div class="col-md-8"><h4><i class="fa fa-angle-right"></i>Formulir Edit Portfolio</h4>
            <br>
            <form class="cmxform form-horizontal style-form" id="commentForm" enctype="multipart/form-data" method="post" action="index.php?include=konfirmasi-edit-portfolio" >
            <div class="col-md-14">
            ...
            <select class="form-control" id="kategori" name="kategori">
              ...
              <?php 
              $sql_l = "SELECT `id`,`kategori` FROM `kategori` ORDER BY `kategori`";
