<?php 
      ...
      $sql = "SELECT `judul`,`isi`,`gambar` FROM `konten`
      WHERE `id`='$id'";
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="content-panel">
                <div class="col-md-8"><h4><i class="fa fa-angle-right"></i>Tampilan Alasan</h4>
            <br>
            <section id="unseen">
                <table class="table table-bordered">
                  <thead class=" text-primary">
                    ...
                    <tr>
                        <td style="width:20%;font-weight:600;">Alasan</td>
                        <td style="width:5%;text-align:center;font-weight:600;">:</td>
