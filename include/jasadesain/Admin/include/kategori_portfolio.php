        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="content-panel">
                <div class="col-md-8"><h4><i class="fa fa-angle-right"></i> List Kategori Portfolio</h4></div>
                <div class="col">
                ...
                <div class="col"><a href="index.php?include=tambah-kategori-portfolio">
                ...
                <table class="table table-responsive table-bordered table-striped table-condensed">
                  ...
                  <tbody>
                    ...
                    <td><?php echo $no;?></td>
                      ...
                      <td align="center">
                      <a href="index.php?include=edit-kategori-portfolio&data=<?php echo $id;?>" 
                      ...
                      'index.php?include=kategori-portfolio&aksi=hapus&data=<?php echo 
