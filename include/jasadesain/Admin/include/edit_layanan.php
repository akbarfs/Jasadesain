...
$sql_k = "SELECT `judul`,`deskripsi` FROM `layanan` WHERE `id`='$id'";
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="content-panel">
                <div class="col-md-8"><h4><i class="fa fa-angle-right"></i>Formulir Edit Layanan</h4>
            <br>
            <form class="cmxform form-horizontal style-form" id="commentForm" enctype="multipart/form-data" method="post" action="index.php?include=konfirmasi-edit-layanan" >
            <div class="col-md-14">
