        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="content-panel">
                <div class="col-md-8"><h4><i class="fa fa-angle-right"></i> List Layanan</h4></div>
                <div class="col">
                ...
                <div class="col"><a href="index.php?include=tambah-layanan">
                ...
                <table class="table table-responsive table-bordered table-striped table-condensed">
                  ...
                  <tbody>
                    ...
                    <td><?php echo $no;?></td>
                      ...
                      <td align="center">
                      <a href="index.php?include=detail-layanan&data=<?php echo $id;?>" 
                      class="btn btn-xs btn-info"><i class="nc-icon nc-alert-circle-i"></i></a>
                      <a href="index.php?include=edit-layanan&data=<?php echo $id;?>" 
                      ...
                      'index.php?include=layanan&aksi=hapus&data=<?php echo 
