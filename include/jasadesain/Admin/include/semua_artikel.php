<section>
        <div class="container mx-auto">
            ...
            <?php 
                    ...
                    $terbit = $data_l[5];
            ?>
                <div class="max-w-full md:max-w-[50%] h-fit md:h-[365px] bg-cover">
                    <img src="./Admin/gmbr/<?php echo $gambar;?>" alt="" srcset="">
                </div class="">
                <div class="w-full px-[5%] text-left py-7 md:py-[2.5%] bg-[#ffe13e] text-[#404040]">
                    <h1 class="text-2xl md:text-4xl font-extrabold md:py-7 text-center md:text-left">
                        <?php echo $judul; ?>
                    </h1>
                    <p class="">
            ...
            <div class="flex flex-col md:flex-row gap-8">
                <div class="md:w-[30%] w-[80%] mx-[10%] md:mx-0 text-center md:text-left pr-3">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi soluta ab quam reiciendis rerum modi.</p>
                </div>
