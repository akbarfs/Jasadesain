<section id="banner">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="main-h1 shade">Jasa <span style="color:#ffe13e;">Desain<span>.co.id</div>
                <p class="shade" style="font-size: medium;margin:0 10%;text-align:justify;">Jasa desain.co.id merupakan
                    Platform Layanan Design bergerak di industri digital design & creative. Berdiri sejak 09 Mei 2019
                    dan sudah berkerjasama dengan ratusan company, organisasi dan komunitas.</p>
                <img class="hero-img shading"
                    style="width:200px;height:fit-content;border-radius:50%; margin-top:10px;margin-bottom:10px;"
            ...
            ?>
                ...
                <p class="motto shade">Pelayanan cepat</p> . <p class="motto shade">Sesuai request</p> . <p
                    class="motto shade">Harga terjangkau</p><br>
            </div>
        </div>
    </div>
    <div class="wave"></div>
...
<section id="layanan">
    <div class="container">
        <div class="row">
                    ...
                    <div class="grid-item">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h3 class="card-header"><?php echo $judul;?></h3>
                                <p class="card-text">
                                    <?php echo $deskripsi;?>
                                </p>
            ...
            <div class="all-layanan btn-center"><a href="index.php?include=semua-layanan"><span>Lihat Semua
                        Layanan</span></a></div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 col-lg-offset-2 col-lg-pull-1 col-sm-8 col-md-8">
                ...
                <a href="http://instagram.com/jasadesain.co.id?igshid=YmMyMTA2M2Y="><img style="width:20px;height:20px;"
                        src="./icons/Ig.png" /></a>
                <a href="https://wa.me/6289636849242"><img style="width:20px;height:20px;" src="./icons/Wa.png" /></a>
                <a href="mailto:Jasadesainapapun@gmail.com"><img style="width:20px;height:20px;"
                        src="./icons/email.png" /></a>
            </div>
